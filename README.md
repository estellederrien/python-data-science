...
Je passe au plus vite en notebooks en Anglais et en Espagnol dans mon autre dépot, ainsi que pour l'étude des ODE en Python(Equations différentielles.) ( Abandon des notebooks en français). 
